...
export default function CourseDetailPage() {
  ...
  const completedCount = dummyTasks.filter(t => t.status === 'completed').length;
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-4 mb-4">
          <div className="flex gap-2">
            <button
              ...
              className={`px-4 py-2 rounded-lg text-sm font-medium font-poppins transition-colors ${
                activeTab === 'all'
                  ? 'bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300'
                  : 'bg-gray-100 dark:bg-gray-700 text-gray-600 dark:text-gray-400 hover:bg-gray-200 dark:hover:bg-gray-600'
              }`}
            >
              Semua Tugas ({dummyTasks.length})
            </button>
            <button
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 mb-4">
          <div className="p-4 border-b border-gray-200 dark:border-gray-700">
            <h2 className="text-xl font-bold text-gray-900 dark:text-white font-rubik">
              General
            </h2>
          </div>
          ...
          <div className="p-4">
            <div className="flex items-center gap-3">
              ...
              <a href="#" className="text-blue-600 dark:text-blue-400 font-poppins hover:underline">
                PAI Kelas XI Semester Ganjil (2025-2026)
              </a>
            </div>
          </div>
        </div>
